 ...
 *	The chosen video is encoded and written to the file "Encoded_Video_Intraframe.bin".
...
string encode(string video_path, int format=3, int shift=0) {
	...
	string encoded_path = "Encoded_Video_Intraframe.bin";
...
int main() {
	...
	string encoded = encode(path + video_name);
